 ...
 *
 * Two things about it drift silently. Its text is published as-is on the Marketplace, and any
 ...
 *
 * So both are checked here, in the same `npm run check` the commit hook runs. The Node a VS Code
