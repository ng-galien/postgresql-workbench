...
export const VSCODE_THEME_ROLE_PROJECTIONS = {
  ...
  // VS Code's default symbol-icon values for these roles inherit the ordinary foreground,
  // which makes valid LSP tokens indistinguishable from unclassified SQL in a webview editor.
